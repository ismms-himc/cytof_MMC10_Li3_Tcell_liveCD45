...
// Simplified loading mult_view.json

d3.json('json/All-MHL-clusters_marker_levels_avg-over-samples.json', function(network_data){
...
function make_clust(network_data){
  ...
  make_sim_mats('Single-MHL-cluster_marker_levels_all_samples_b_cell_1', cat_colors);
